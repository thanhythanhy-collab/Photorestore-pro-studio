...
export const TECHNICAL_KEYWORDS: KeywordItem[] = [
  ...
  { en: 'Sharp iris geometry & catchlight', vi: 'Vân mống mắt & Đốm sáng giác mạc', description: 'Tái tạo ánh mắt có hồn, sáng trong tự nhiên', category: 'Facial Fidelity' },
  ...
  { en: 'Organic skin micro-texture', vi: 'Vân da vi mô tự nhiên', description: 'Hiển thị lưới lỗ chân lông tự nhiên mịn màng', category: 'Skin & Texture' },
  { en: 'Subsurface scattering SSS', vi: 'Tán xạ ánh sáng dưới da (SSS)', description: 'Tạo độ mướt và ấm áp tự nhiên của da người thật', category: 'Skin & Texture' },
  ...
  { en: '35mm organic film grain', vi: 'Hạt phim 35mm bạc muối tự nhiên', description: 'Tạo chiều sâu điện ảnh analog, tránh phẳng lì kỹ thuật số', category: 'Skin & Texture' },
  { en: 'Microscopic fabric weave', vi: 'Chi tiết thớ vải dệt vi mô', description: 'Phục hồi sợi tơ tằm, gấm thêu và chống cháy sáng áo trắng', category: 'Skin & Texture' },
  ...
  { en: 'Calibrated CMYK print proofing', vi: 'Cân chuẩn màu in Lab CMYK', description: 'Triệt tiêu lệch màu khi in rọi máy chuyên nghiệp', category: 'Print Ready' },
